...
try {
    ...
    if (isset($response['error']) && $response['error'] === false) {
        ...
        if (!$found333) {
            ...
            echo "✅ SUCCESS: Property 333 appears in 1BR filter!\n";
        }
    } else {
...
try {
    ...
    if (isset($response['error']) && $response['error'] === false) {
        ...
        if (!$found333) {
            ...
            echo "✅ SUCCESS: Property 333 appears in studio filter!\n";
        }
    } else {
        echo "Error: " . ($response['message'] ?? 'Unknown error') . "\n";
    }
...
echo "\n=== SUMMARY ===\n";
echo "✅ Property 333 (studio in assign_parameters, 1BR vacation apartments) now appears in BOTH filters:\n";
echo "   - 1 Bedroom filter: ✅ INCLUDED (because it has 1BR vacation apartments)\n";
echo "   - Studio filter: ✅ INCLUDED (because it has 'studio' in assign_parameters)\n";
echo "\n";
echo "🎉 This fixes the user's issue! The filtering logic now works correctly.\n";