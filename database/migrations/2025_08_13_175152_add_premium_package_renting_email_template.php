...
return new class extends Migration
{
    ...
    {
        // Add premium package renting contract email template
        $premiumPackageRentingTemplate = '<p>AY: {agreement_year}</p>
...
<p>Date: {contract_date}</p>';
        ...
        Setting::updateOrCreate(
            ...
            ['data' => $premiumPackageRentingTemplate]
        );
    }
    ...
    {
        // Remove the premium package renting contract email template
        Setting::where('type', 'premium_package_renting_mail_template')->delete();
    }
};
