...
return new class extends Migration
{
    ...
    {
        // Add flexible reservation confirmation email template
...
<p>The <strong>{app_name}</strong> Team</p>';
    ...
    {
        // Remove the flexible reservation confirmation email template
        Setting::where('type', 'flexible_reservation_confirmation_mail_template')->delete();
    }
};
