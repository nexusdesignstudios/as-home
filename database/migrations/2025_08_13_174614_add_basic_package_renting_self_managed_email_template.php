...
return new class extends Migration
{
    ...
    {
        // Add basic package renting self managed contract email template
        $basicPackageRentingSelfManagedTemplate = '<p>AY: {agreement_year}</p>
...
<p>And You (the "Partner") For Long Term Rent Furnished or Unfurnished Units – Basic Package:</p>
...
<p>Date: {contract_date}</p>';
        ...
        Setting::updateOrCreate(
            ...
            ['data' => $basicPackageRentingSelfManagedTemplate]
        );
    }
    ...
    {
        // Remove the basic package renting self managed contract email template
        Setting::where('type', 'basic_package_renting_self_managed_mail_template')->delete();
    }
};
