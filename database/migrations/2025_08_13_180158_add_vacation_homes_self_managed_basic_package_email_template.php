...
return new class extends Migration
{
    ...
    {
        // Add vacation homes self managed basic package contract email template
        $vacationHomesSelfManagedBasicPackageTemplate = '<p>AY: {agreement_year}</p>
...
<p>And You (the "Partner") For Long Term Rent Furnished or Unfurnished Units – Premium Package:</p>
...
<p>Date: {contract_date}</p>';
        ...
        Setting::updateOrCreate(
            ...
            ['data' => $vacationHomesSelfManagedBasicPackageTemplate]
        );
    }
    ...
    {
        // Remove the vacation homes self managed basic package contract email template
        Setting::where('type', 'vacation_homes_self_managed_basic_package_mail_template')->delete();
    }
};
