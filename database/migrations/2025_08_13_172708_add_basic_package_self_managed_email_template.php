...
return new class extends Migration
{
    ...
    {
        // Add basic package self managed contract email template
        $basicPackageSelfManagedTemplate = '<p>AY: {agreement_year}</p>
...
<p>And You (the "Partner") For Sale Furnished or Unfurnished Units:</p>
...
<p>Date: {contract_date}</p>';
        ...
        Setting::updateOrCreate(
            ...
            ['data' => $basicPackageSelfManagedTemplate]
        );
    }
    ...
    {
        // Remove the basic package self managed contract email template
        Setting::where('type', 'basic_package_self_managed_mail_template')->delete();
    }
};
