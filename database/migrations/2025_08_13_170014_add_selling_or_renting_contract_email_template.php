...
return new class extends Migration
{
    ...
    {
        // Add selling or renting contract email template
        $sellingOrRentingContractTemplate = '<p>AY: {agreement_year}</p>
...
<p>And You (the "Partner") For Online Marketing – Selling or Renting Units:</p>
...
<p>Date: {contract_date}</p>';
        ...
        Setting::updateOrCreate(
            ...
            ['data' => $sellingOrRentingContractTemplate]
        );
    }
    ...
    {
        // Remove the selling or renting contract email template
        Setting::where('type', 'selling_or_renting_contract_mail_template')->delete();
    }
};
