...
return new class extends Migration
{
    ...
    public function up()
    {
        // First, remove the old approval template if it exists
        DB::table('settings')->where('type', 'flexible_hotel_booking_approval_mail_template')->delete();
        
        // Insert the correct confirmation email template
    ...
    {
        DB::table('settings')->where('type', 'flexible_hotel_booking_confirmation_mail_template')->delete();
    }
};