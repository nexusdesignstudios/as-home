...
return new class extends Migration
{
    ...
    {
        // Add hotel booking contract email template
        $hotelBookingTemplate = '<p>AY: {agreement_year}</p>
...
<p>And You (the "Partner") For Hotel Bookings:</p>
...
<p>Date: {contract_date}</p>';
    ...
    {
        // Remove the hotel booking contract email template
        Setting::where('type', 'hotel_booking_mail_template')->delete();
    }
};
