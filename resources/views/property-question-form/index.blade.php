...
@section('title')
    {{ __('Property Question Form') }} - {{ ucfirst($classification) }}
@endsection
...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="divider">
                        <div class="divider-text">
                            <h4>{{ __('Create Property Question Field') }}</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                {!! Form::open(['url' => route('property-question-form.store'), 'data-parsley-validate', 'files' => true, 'class' => 'create-form','data-pre-submit-function','data-success-function'=> "formSuccessFunction"]) !!}
                                    @csrf
                                    <input type="hidden" name="property_classification" value="{{ $classificationId }}">
                                    <div class="row">
                                        {{-- Name --}}
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="table table-striped"
                                id="table_list" data-toggle="table" data-url="{{ route('property-question-form.show', ['property_classification' => $classificationId]) }}"
    ...
    <!-- EDIT MODEL MODEL -->
    <div id="editModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="propertyQuestionFieldEditModal"
        aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="propertyQuestionFieldEditModal">{{ __('Edit Property Question Field') }}</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal create-form" action="{{ route('property-question-form.update') }}" enctype="multipart/form-data" data-parsley-validate data-success-function="editFormSuccessFunction">
                        {{ csrf_field() }}
    ...
    <script>
        function queryParams(p) {
            return {
                ...
                limit: p.limit,
                search: p.search,
                property_classification_ids: @json($classificationIds)
            };
        }
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '.status-switch', function() {
                ...
                $.ajax({
                    url: "{{ route('property-question-form.status') }}",
                    type: "POST",
                    data: {
                        id: id,
                        status: status,
