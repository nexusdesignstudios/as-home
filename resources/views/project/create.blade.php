                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            {{ Form::text('bedroom', '', [ 'class' => 'form-control', 'placeholder' => __('Bedroom'), 'id' => 'bedroom' ]) }}
                        </div>
                        <div class="col-md-6 form-group">
                            {{ Form::label('bathroom', __('Bathroom'), ['class' => 'form-label col-12 ']) }}
                            {{ Form::text('bathroom', '', [ 'class' => 'form-control', 'placeholder' => __('Bathroom'), 'id' => 'bathroom' ]) }}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            {{ Form::text('garage', '', [ 'class' => 'form-control', 'placeholder' => __('Garage'), 'id' => 'garage' ]) }}
                        </div>
                        <div class="col-md-6 form-group">
                            {{ Form::label('year_built', __('Year Built'), ['class' => 'form-label col-12 ']) }}
                            {{ Form::text('year_built', '', [ 'class' => 'form-control', 'placeholder' => __('Year Built'), 'id' => 'year_built' ]) }}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            {{ Form::text('lot_size', '', [ 'class' => 'form-control', 'placeholder' => __('Lot Size'), 'id' => 'lot_size' ]) }}
                        </div>
                    </div>
                </div>
            </div>
