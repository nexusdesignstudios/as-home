    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h4>@yield('title')</h4>
                <p class="text-subtitle text-muted">{{ __('View all transaction history') }}</p>
            </div>
            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        <button id="filter_btn" class="btn btn-primary me-2">{{ __('Filter') }}</button>
                        <button id="reset_btn" class="btn btn-secondary">{{ __('Reset') }}</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <table class="table-light" aria-describedby="mydesc" class='table-striped' id="table_list"
                            data-toggle="table" data-url="{{ route('transactions.list') }}" data-click-to-select="true"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="created_at" data-align="center" data-sortable="true">{{ __('Payment Date') }}</th>
...
@section('script')
    <script>
        ...
        function paymentStatusFormatter(value, row) {
            let badgeClass = '';
