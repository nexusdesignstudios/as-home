...
<div class="web-section">
    <div class="home-wrap">
        ...
        <div class="web-grid">
            ...
            @endphp
            <a class="web-card" href="{{ route('listing.show', $property->id) }}" style="display:block;text-decoration:none;color:inherit;">
                <div class="hero">
                    <img src="{{ $img }}" alt="{{ $property->title }}" loading="lazy">
                    <span class="tag">{{ $verticalTag }}</span>
                    <button class="heart" aria-label="Save" onclick="event.preventDefault();">
