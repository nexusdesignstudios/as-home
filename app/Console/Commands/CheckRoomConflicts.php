...
class CheckRoomConflicts extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reservations:check-conflicts';
     ...
     * @var string
     */
    protected $description = 'Check for conflicting hotel room reservations';
