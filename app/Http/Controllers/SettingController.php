...
class SettingController extends Controller
{
    ...
    public function modifyMailTemplateIndex($type)
    {
        ...
        $types = array('verify_mail', 'reset_password', 'welcome_mail', 'property_status', 'project_status', 'property_ads_status', 'user_status', 'agent_verification_status', 'reservation_confirmation', 'monthly_tax_invoice', 'selling_or_renting_contract', 'basic_package_self_managed', 'basic_package_renting_self_managed', 'premium_package_renting', 'vacation_homes_self_managed_basic_package', 'vacation_homes_ashome_managed_premium_package', 'hotel_booking', 'property_client_meeting', 'inquiry_form','reservation_approval_mail_template');
