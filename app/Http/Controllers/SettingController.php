...
class SettingController extends Controller
{
    ...
    public function modifyMailTemplateIndex($type)
    {
        ...
        $types = array('verify_mail', 'reset_password', 'welcome_mail', 'property_status', 'project_status', 'property_ads_status', 'user_status', 'agent_verification_status', 'reservation_confirmation', 'reservation_approval', 'monthly_tax_invoice', 'monthly_tax_invoice_hotels_non_refundable', 'monthly_tax_invoice_hotels_flexible', 'vacation_homes_basic_tax_invoice', 'vacation_homes_premium_tax_invoice', 'hotel_booking_tax_invoice', 'hotel_booking_tax_invoice_flexible', 'hotel_booking_tax_invoice_non_refundable', 'selling_or_renting_contract', 'list_property_sell_contract', 'list_property_rent_contract', 'basic_package_self_managed', 'basic_package_renting_self_managed', 'premium_package_renting', 'vacation_homes_self_managed_basic_package', 'vacation_homes_ashome_managed_premium_package', 'hotel_booking', 'property_client_meeting', 'orientation_day_confirmation', 'inquiry_form', 'reservation_approval_payment', 'vacation_home_pending_approval', 'vacation_home_owner_booking_notification', 'flexible_hotel_booking_approval', 'send_money_payment', 'refund_approval', 'refund_rejection', 'reservation_rejection', 'reservation_cancellation', 'checkout_reminder', 'payment_form_submission', 'feedback_request', 'payment_completion_owner', 'bank_payment_accepted', 'bank_payment_rejected', 'subscription_success');
        ...
        if ($data === null) {
            ResponseService::errorRedirectResponse("Invalid email template type");
        }
