...
class SettingController extends Controller
{
    ...
    public function systemSettingsIndex()
    {
        ...
        return view('settings.system-settings', compact('systemSettings', 'languages', 'paypalCurrencies', 'listOfCurrencies', 'bankDetailsFields'));
    }
...
<p>Best regards,</p>
<p>The <strong>{app_name}</strong> Team</p>';
            } elseif ($type === 'flexible_reservation_confirmation') {
                // Default flexible reservation confirmation template
                $templateMailData = '<p>Dear <strong>{user_name}</strong>,</p>
<p>Thank you for your reservation with <strong>{app_name}</strong>! Your flexible booking has been confirmed.</p>
<p><strong>Reservation Details:</strong></p>
<ul>
<li><strong>Reservation ID:</strong> {reservation_id}</li>
<li><strong>Property:</strong> {property_name}</li>
...
The <strong>{app_name}</strong> Team</p>';
                ...
                $templateMailData = '<p>Dear <strong>{owner_name}</strong>,</p>
<p>This is to inform you that a reservation has been cancelled.</p>
<p><strong>Reservation Details:</strong></p>
...
<strong>Cancellation Date:</strong> {cancellation_date}</p>
<p>If you have any questions, please contact our support team.</p>
<p>Best regards,<br>
