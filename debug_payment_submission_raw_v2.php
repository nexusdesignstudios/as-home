...
try {
    ...
    // Handling the request automatically boots the application and facades
    ...
    try {
        ...
        // We continue to try to hit the controller even if DB fails, to see if validation works
    }
