...
// Test the actual query logic step by step - FIXED VERSION
...
foreach ($vacationHomes as $property) {
    ...
    // Check assign_parameters bedroom - FIXED to check modal_id
    ...
    echo "  Assign Parameters Bedroom: " . ($assignBedroom ? $assignBedroom->value : 'None') . "\n";
